...
<p>$$W(\mathbb{P}_r, \mathbb{P}_g)=\sup_{||f||_{L}\leq 1} \mathbb_{x \sim \mathbb{P}_r}[f(x)]- \mathbb_{x \sim \mathbb{P}_{\theta}}[f(x)]$$</p>
<p>The equation above can be considered to be equivalent to：</p>
<p>$$\max_{||f||_{L}\leq 1} \mathbb_{x \sim \mathbb{P}_r}[f(x)]- \mathbb_{x \sim \mathbb{P}_{\theta}}[f(x)]$$</p>
