...
<table border="1">
    <tr>
        <td><font face="黑体" size=4>**Symbol**</font></td>
        <td><font face="黑体" size=4>**Meaning**</font></td>
    </tr>
...
*$E_{in}(h) \approx $E_{out}(h) $, this means that $h$ have generality can be expended to the whole dataset. \
