...
Set:<br />
$$\delt = 4(2N)^{d_{vc}}exp(-\frac{1}{8}\epsilon^2N)$$
Then:<br />
$$\squar{frac{8}{N}ln(frac{4(2N)^{d_{vc}}}{\delt})}=\epsilon$$
by replace $\epsilon with (8)$:
$$|E_{in}(h)-E_{out}(h)|> \squar{frac{8}{N}ln(frac{4(2N)^{d_{vc}}}{\delt})} $$
Then, we get:
$$E_{in}(h)-\squar{frac{8}{N}ln(frac{4(2N)^{d_{vc}}}{\delt})}  \leg E_{out}(h) \leg E_{in}(h)+ \squar{frac{8}{N}ln(frac{4(2N)^{d_{vc}}}{\delt})}$$
