...
<p>Thrun, Sebastian. "Is learning the n-th thing any easier than learning the first?."<em>Advances in neural information processing systems</em>8 (1995).</p>
</div>
</div>
<div class="relative flex flex-col w-[calc(100%-50px)] gap-1 md:gap-3 lg:w-[calc(100%-115px)]">
...
<p>Method 1: k-nearest neighbor.</p>
...
<p>Method 2: Shepard, averaging Y with the distances between $\langle x_i,y_i \rangle$ and all points in $X_k$ as weights to obtain $y_i$.</p>
...
<p>Method 3: Learn a new set of latent variables to represent the original variables.</p>
...
<p>Method 4: Learn a distance function.</p>
...
<p>Neural network-based methods<br />Method 1: Clue-Based Learning</p>
